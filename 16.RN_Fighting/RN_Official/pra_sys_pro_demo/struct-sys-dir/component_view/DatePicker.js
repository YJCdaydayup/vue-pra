...
export class DatePicker extends Component {
    ...
    constructor(props) {
        ...
        this.textStyle = typeof props.textStyle === 'function' ? props.textStyle() : (props.titleTextStyle || {color: Colors.gray153153})
    ...
    sizeMonth = (selectValue) => {
        if (selectValue === 3 || selectValue === 5 || selectValue === 8 || selectValue === 10) {
            this.setState({
                days: this.returnNum(31, 2),
            })
        } else if (selectValue === 1) {
            if (this.isLeapYearMethod(this.selectYears)) {
                this.setState({
                    days: this.returnNum(30, 2),
                },)
            } else {
                this.setState({
                    days: this.returnNum(29, 2),
                })
            }
        } else {
            this.setState({
                days: this.returnNum(32, 2),
            })
        }
    }
