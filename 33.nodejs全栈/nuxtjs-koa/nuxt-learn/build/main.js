...
/* harmony import */ var _interface_city__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_interface_city__WEBPACK_IMPORTED_MODULE_2__);
...
async function start() {
  ...
  app.use(_interface_city__WEBPACK_IMPORTED_MODULE_2___default.a.routes()).use(_interface_city__WEBPACK_IMPORTED_MODULE_2___default.a.allowedMethods());
  app.use(ctx => {
    ctx.status = 200;
